...
let sz = { left: 0, top: 0, width: 200, height: 100 };
...
export default function useOnboarding(steps, title) {
  ...
  function Highligh() {
    ...
    useEffect(() => {
      ...
      if (sz.left + left + MIN_WTT + 10 > window.innerWidth) {
        top = sz.height + 10;
        left = window.innerWidth - sz.left - MIN_WTT - 20;
        pos = 'top';
        posF = -left + sz.width / 2;
      }
